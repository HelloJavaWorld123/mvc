...
import com.jzy.api.service.biz.impl.WXPayRequest;
...
public class WXPay {
    ...
    public WXPay(final WXPayConfig config) throws Exception {
        this(config, config.getNotifyUrl(), true, false);
    }

    public WXPay(final WXPayConfig config, final boolean useSandbox) throws Exception {
        this(config, config.getNotifyUrl(), true, useSandbox);
    }

    public WXPay(final WXPayConfig config, final boolean autoReport, final boolean useSandbox) throws Exception {
        this(config, config.getNotifyUrl(), autoReport, useSandbox);
    }
